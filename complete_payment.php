...
if($otp=="123456")
{
    ...
    mysqli_query($con,"insert into booking (b_bookid,b_theatre,b_unm,b_show,b_amt,b_date,b_time) values('$bookid','".$_SESSION['theatre']."','".$_SESSION['client']['uid']."','".$_SESSION['show']."','".$_SESSION['amount']."','".$_SESSION['date']."',$time)");
   $seat= $_SESSION['seats'];
